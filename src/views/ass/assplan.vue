        ...
        <a-row :gutter="24">
          ...
          <a-col :span="8">
            <a-form-item label="评定计划名称">
              <a-input placeholder="请输入名称查询" v-model="queryParam.planname"></a-input>
            </a-form-item>
          </a-col>
        <!--  <a-col :span="8">
            <a-form-item
              ...
              <a-range-picker @change="onChangeDate" v-model="queryParam.startdate"/>
            </a-form-item>
          </a-col>
          <a-col :span="8">
            <a-form-item
              ...
              :labelCol="{span: 5}"
              :wrapperCol="{span: 18, offset: 1}">
              <a-range-picker @change="onChangeDate" v-model="queryParam.enddate"/>
            </a-form-item>
          </a-col>-->
...
<!--      <a-button type="primary" icon="plus" @click="jump">创建单据</a-button>
    ...
    <!-- 表单区域 -->
    <AssPlan-modal ref="AssPlanModal" @ok="modalFormOk"></AssPlan-modal>
...
<script>
  ...
  import AssPlanModal from './modules/AssPlanModal'
  ...
  export default {
    ...
    data() {
      return {
        ...
        selectedRows: [],
        url: {
          list: "/ws/assplan/list",
          delete: "/ws/assplan/delete",
          deleteBatch: "/ws/assplan/deleteBatch",
        },
      }
    },
    created() {
    ...
    methods: {
      ...
      handleEdit: function (record) {
        this.$refs.AssPlanModal.edit(record);
        this.$refs.AssPlanModal.title = "编辑";
      },
      ...
      handleAdd: function () {
        this.$refs.AssPlanModal.add();
        this.$refs.AssPlanModal.title = "新增";
      },
