<template>
  <a-card :bordered="false"><!--:bordered="false"-->
    ...
    <!--  <a-button @click="handleAdd" type="primary" icon="plus">新增</a-button>
      <a-button type="primary" icon="plus" @click="problemBack">回复</a-button>-->
    ...
    <!-- table区域-end -->
    <StepForm ref="StepForm" @ok="modalFormOk"></StepForm>
    <!-- 表单区域 -->
    <ProbModal ref="ProbModal" @ok="modalFormOk"></ProbModal>
...
<script>
  import ProbModal from './modules/ProbModal'
  import StepForm from './StepFormModal'
  ...
  export default {
    ...
    methods: {
      ...
      handleEdit: function(record) {
        this.$refs.ProbModal.edit(record)
        this.$refs.ProbModal.title = '编辑'
      },
      ...
      handleAdd: function() {
        this.$refs.ProbModal.add()
        this.$refs.ProbModal.title = '新增'
      },
      problemBack: function() {
        ...
        this.$refs.StepForm.add(this.selectedRowKeys[0])
      },
