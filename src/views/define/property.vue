<template>
  <a-card :bordered="false"><!--:bordered="false"-->
    ...
    <!-- 表单区域 -->
    <Prop-modal ref="PropModal" @ok="modalFormOk"></Prop-modal>
...
<script>
  import PropModal from './modules/PropModal'
      ...
      return {
        ...
        columns: [
          ...
          },
          {
            title: '属性值正常标志',
            align: "center",
            dataIndex: 'propertyflag'
          },
          {
            title: '属性值最大值',
            align: "center",
            dataIndex: 'porpertymax'
          },
          {
            title: '属性值最小值',
            align: "center",
            dataIndex: 'propertymin'
          },
          {
            title: '备注',
            align: "center",
   ...
   /*     isorter: {
    ...
    methods: {
      ...
      handleEdit: function (record) {
        this.$refs.PropModal.edit(record);
        this.$refs.PropModal.title = "编辑";
      },
      ...
      handleAdd: function () {
        this.$refs.PropModal.add();
        this.$refs.PropModal.title = "新增";
      },
